...
public class AnimationPlayer {
    ...
    private Collection<AnimationChannel> animationChannelCollection;
    ...
    public void AnimationPlayer() {
        playerAnimationList = new ArrayList<AnimationChannel>();
        zombieAnimationList = new ArrayList<AnimationChannel>();
        ...
        zombieAnimationList.add(new AnimationChannel("attackiZombie.png", 6, width, height, attackDuration, 0, 11));    //AttackFront
        zombieAnimationList.add(new AnimationChannel("attackiZombie.png", 6, width, height, attackDuration, 12, 23));   //AttackSide
        zombieAnimationList.add(new AnimationChannel("attackiZombie.png", 6, width, height, attackDuration, 24, 35));   //AttackBack
        zombieAnimationList.add(new AnimationChannel("walkZombie.png", 4, width, height, walkDuration, 0, 3));          //WalkFront
        zombieAnimationList.add(new AnimationChannel("walkZombie.png", 4, width, height, walkDuration, 4, 7));          //WalkSide
        zombieAnimationList.add(new AnimationChannel("walkZombie.png", 4, width, height, walkDuration, 8, 11));         //WalkBack
