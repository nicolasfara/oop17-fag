...
/**
 * This class is used to assign to an entity a movement.
 */
public class SimpleMovement extends AbstractMovement {
     ...
     */
    public SimpleMovement(final PositionComponent positionComponent) {
        super();
