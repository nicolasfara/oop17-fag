 ...
 */
public class ScoreImpl implements Score<String, Integer>, Serializable {
     ...
     */
    public ScoreImpl(final String username, final Integer score) {
